...
``` python
render_md("Here's a sentence with a footnote[^aa] and another[^bb].\n\n[^aa]: First note.\n[^bb]: Second note.")
```

<p>Here's a sentence with a footnote<sup><a href="#fn-aa" id="fnref-aa">[aa]</a></sup> and another<sup><a href="#fn-bb" id="fnref-bb">[bb]</a></sup>.</p>
<div id="fn-aa" class="footnote"><sup>aa</sup> First note. <a href="#fnref-aa">↩</a></div>
&#10;<div id="fn-bb" class="footnote"><sup>bb</sup> Second note. <a href="#fnref-bb">↩</a></div>
